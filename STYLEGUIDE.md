# Wisterion UI Style Guide (Updated — Inter + New Palette)
...
All named colors below are the formal Wisterion tokens. The palette is designed to be used sparingly, with most surfaces remaining neutral.
