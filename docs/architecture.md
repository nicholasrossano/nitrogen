...
Nitrogen is a chat-first diligence workbench: **projects** hold shared deal state; **core chat** handles personal and project-scoped research; **findings** and **variables** capture promoted team knowledge. The backend is FastAPI + PostgreSQL/pgvector; the frontend is Next.js.
