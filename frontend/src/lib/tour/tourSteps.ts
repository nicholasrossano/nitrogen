...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Suggested analyses for this project appear here. Open one when you are ready to begin.',
    placement: 'top',
  },
  {
  ...
  // --- Feature discovery (first visit to each surface) ---
  {
    ...
    title: 'Status',
    body: 'Track initiative health and progress here. Open any row to review the underlying documents or assessments.',
    placement: 'bottom',
    trigger: 'mount',
  },
  {
