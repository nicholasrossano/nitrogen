...
Chat-first decision packet studio. Generate memos grounded in evidence through conversational AI.
...
3. **Memo Generation** - Generate an memo with citations from both your evidence and a curated case study corpus
