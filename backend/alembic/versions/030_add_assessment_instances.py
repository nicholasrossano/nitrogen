"""Add assessment_instances table and backfill from deliverables/tool_alignments
...
def upgrade():
    ...
    op.create_index('ix_mi_initiative_session', 'assessment_instances',
...
def downgrade():
    op.drop_index('ix_mi_initiative_session', table_name='assessment_instances')
