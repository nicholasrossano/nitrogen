...
class MemoGeneratorService:
    """Service for generating memos using RAG"""
...
"""
        ...
        response = await acompletion(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": f"""Generate an memo for this initiative.
...
"""
    ...
    def _default_generation_prompt(self) -> str:
        return """You are an expert analyst generating memos for development initiatives.
