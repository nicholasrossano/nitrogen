...
def get_first_party_catalog() -> FirstPartyAssessmentCatalog:
    ...
    return FirstPartyAssessmentCatalog(
        ...
        recommendation_keywords={
            ...
            "cookstove": ("carbon_model",),
            "clean cooking": ("carbon_model", "stakeholder_assessment"),
            "solar": ("solar_estimate", "lcoe_model"),
            "pv": ("solar_estimate",),
            "photovoltaic": ("solar_estimate",),
            "irradiance": ("solar_estimate",),
            "mini-grid": ("solar_estimate", "lcoe_model", "stakeholder_assessment"),
            "minigrid": ("solar_estimate", "lcoe_model", "stakeholder_assessment"),
            "microgrid": ("solar_estimate", "lcoe_model"),
            "stakeholder": ("stakeholder_assessment",),
            "community engagement": ("stakeholder_assessment",),
            "partners": ("stakeholder_assessment",),
            "landscape": ("landscape_mapping",),
            "ecosystem": ("landscape_mapping",),
            "market map": ("landscape_mapping",),
            "actors": ("landscape_mapping",),
        },
