...
def _register_standalone_tools(registry: CapabilityRegistry) -> None:
    registry.register(CapabilityEntry(
        id="search_project_documents",
        kind=CapabilityKind.INTERNAL_TOOL,
        name="Search Project Documents",
        description="Search uploaded project documents and materials for project-specific details.",
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "query": {
                            "type": "string",
                            "description": "Focused query for project document retrieval (max 20 words).",
                        },
                        "reason": {
                            "type": "string",
                            "description": "One sentence explaining why project document search is needed.",
                        },
                    },
