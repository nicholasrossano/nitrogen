...
from app.modules.utils import infer_category_icon, llm_json


class ImplementationPlanModule(BaseModule):
    """Convert project framework data into an execution-oriented module workflow."""
    ...
    async def compute_stage(
        ...
        return {"groups": groups, "module_id": "implementation_plan"}
    ...
    async def _propose_activities(
        ...
        data = await llm_json(
            system=(
                "You are converting a sustainable development project framework into an implementation module. "
