"""Template for a Nitrogen assessment module using the staged workflow.

Assessment modules are an ordered sequence of confirmable stages:
...
class ExampleLayeredModule(BaseModule):
    @property
