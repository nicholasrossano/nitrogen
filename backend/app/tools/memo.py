...
"""
    ...
    async def update_alignment_from_feedback(
        ...
        system_prompt = """You are helping refine an memo outline based on user feedback.
...
"""
    ...
    async def _generate_content(self, project_summary: str, context: str, alignment_instructions: str | None = None) -> dict:
        ...
        base_system_prompt = """You are an expert analyst generating memos for development initiatives.
