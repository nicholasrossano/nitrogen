...
**Rule 12a: A confirmed project variable already answers the requested input**
→ Prefer the confirmed variable. If the variable needs review, say so and help the user verify it. If it is missing, use **propose_input_value** or ask for the value depending on the user's request.
