...
2. States what teams typically prepare for this type of project (be specific - e.g., "For renewable energy projects, teams typically prepare memos and due diligence checklists")
3. Introduces the recommendations below

RULES:
- 2-3 sentences maximum
- Be proactive and knowledgeable - tell them what practitioners typically do
- Reference specific deliverables (memos, due diligence checklists, etc.)
...
Example: "I have everything I need - here's what I'll prepare for you:" """
        ...
        return f"""You are a helpful assistant for Nitrogen, a platform that helps development professionals create project documentation like memos and due diligence checklists.
