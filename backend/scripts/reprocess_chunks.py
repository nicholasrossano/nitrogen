"""Backfill content_html and page_number for existing evidence chunks.
...
async def main():
    print("=== Reprocessing evidence chunks for content_html / page_number ===\n")
    e_up, e_sk, e_err = await reprocess_evidence()
    print("\n=== Done ===")
    print(f"Total updated: {e_up}")
    print(f"Total skipped: {e_sk}")
    print(f"Total errors:  {e_err}")
